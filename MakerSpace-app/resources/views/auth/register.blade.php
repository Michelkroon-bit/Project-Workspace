<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <a class="underline text-sm text-[#858585] hover:text-[#93D2ED] rounded-md focus:outline-none focus:ring-2 focus:ring-[#93D2ED] focus:ring-offset-[#121212] focus:ring-offset-2" href="{{ route('login') }}">
